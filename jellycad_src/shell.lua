...
shell = cylinder.new(config.r_shell_outer, config.h_shell)
-- CAN插口槽
...
-- 合并连接台
local connecter = cylinder.new(config.r_shell_outer, config.r_shell_outer + config.h_flank):z(config.r_shell_outer):ry(90)
